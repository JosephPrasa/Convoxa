                ...
                <Row className="h-100 g-0">
                    <Col className="h-100 overflow-auto custom-scrollbar bg-black bg-opacity-25">
                        <div className="p-5 mw-100" style={{ maxWidth: "800px", margin: "0 auto" }}>
                            <h2 className="mb-4 fw-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>Privacy Centre</h2>
                            <p className="text-white-50">Manage your privacy settings and learn how we protect your data.</p>
...
export default PrivacyCentrePage;
